...
Run: `cd /home/astre/command-center/src/greenlit/collections && pytest tests/browser_scraper/test_permit_tasks.py::test_the_colony_has_detail_extraction -v`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && pytest tests/browser_scraper/test_permit_tasks.py::test_the_colony_bulk_extracts_multiple_permits -v`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && pytest tests/browser_scraper/test_permit_tasks.py -k "the_colony" -v`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3.11 -c "from services.browser_scraper.runner import PermitScraperRunner; print('OK')"`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scripts/load_permits.py --city the_colony`
