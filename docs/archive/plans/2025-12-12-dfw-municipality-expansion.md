...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/etrakit_fast.py keller 10`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/citizen_self_service.py cedar_hill 10`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/citizen_self_service.py desoto 10`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/mygov_multi.py mansfield 10`
...
See separate plan: `docs/archive/plans/2025-12-12-sachse-smartgov-scraper.md`
...
**Files:**
- Modify: `/home/astre/command-center/src/greenlit/collections/CLAUDE.md`
...
**Files:**
- Modify: `/home/astre/command-center/src/greenlit/collections/TODO.md`
