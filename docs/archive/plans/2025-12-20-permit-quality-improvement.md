...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 -m pytest tests/test_arlington_socrata.py -v`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 -m pytest tests/test_arlington_socrata.py::test_arlington_permit_type_mapping -v`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 -m pytest tests/test_arlington_socrata.py::test_arlington_extraction_maps_types -v`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/dfw_big4_socrata.py --city arlington --limit 10`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 -m pytest tests/test_etrakit_detail.py -v`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 -m pytest tests/test_etrakit_detail.py::test_parse_etrakit_date -v`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 -c "
import asyncio
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/etrakit.py denton 10`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 -m pytest tests/test_cityview_dates.py -v`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && PGPASSWORD=localdev123 psql -h localhost -U contractors_user -d contractors_dev -c "SELECT MAX(issued_date), COUNT(*) FROM leads_permit WHERE city = 'arlington';"`

Expected: Shows Nov 14 as max date (stale)

**Step 2: Run Arlington scraper**

Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/dfw_big4_socrata.py --city arlington`

**Step 3: Load new permits to database**

Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scripts/load_permits.py`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && PGPASSWORD=localdev123 psql -h localhost -U contractors_user -d contractors_dev -c "SELECT permit_id, permit_type, issued_date FROM leads_permit WHERE city = 'denton' LIMIT 5;"`

Expected: Shows NULL dates and empty types

**Step 2: Run Denton scraper with detail extraction**

Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/etrakit.py denton 200`

**Step 3: Verify output JSON has dates**

Run: `cd /home/astre/command-center/src/greenlit/collections && head -50 data/raw/denton_raw.json | grep -E '"issued_date"|"permit_type"'`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && PGPASSWORD=localdev123 psql -h localhost -U contractors_user -d contractors_dev -c "SELECT permit_id, permit_type, issued_date FROM leads_permit WHERE city = 'denton' AND issued_date IS NOT NULL LIMIT 5;"`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/etrakit.py prosper 200`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && PGPASSWORD=localdev123 psql -h localhost -U contractors_user -d contractors_dev -c "SELECT permit_id, permit_type, issued_date FROM leads_permit WHERE city = 'prosper' AND issued_date IS NOT NULL LIMIT 5;"`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/cityview.py carrollton 200`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && PGPASSWORD=localdev123 psql -h localhost -U contractors_user -d contractors_dev -c "SELECT permit_id, permit_type, issued_date FROM leads_permit WHERE city = 'carrollton' AND issued_date IS NOT NULL LIMIT 5;"`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scripts/enrich_cad.py`

**Step 2: Run AI scoring**

Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scripts/score_leads.py`

**Step 3: Verify premium lead increase**

Run: `cd /home/astre/command-center/src/greenlit/collections && PGPASSWORD=localdev123 psql -h localhost -U contractors_user -d contractors_dev -c "
SELECT
    p.city,
    COUNT(*) as total,
...
## Task 12: Update docs/archive/SCRAPER_STATUS.md

**Files:**
- Modify: `docs/archive/SCRAPER_STATUS.md`
...
```bash
git add docs/archive/SCRAPER_STATUS.md
