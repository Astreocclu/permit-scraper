...
Run: `cd /home/astre/command-center/src/greenlit/collections && pytest tests/services/property_images/test_redfin_scraper.py -v --timeout=120`
...
```bash
cd /home/astre/command-center/src/greenlit/collections && git add services/property_images/redfin_scraper.py
...
Run: `cd /home/astre/command-center/src/greenlit/collections && pytest tests/services/property_images/test_redfin_scraper.py::TestRedfinScraper::test_retry_constants_exist -v`
...
```bash
cd /home/astre/command-center/src/greenlit/collections && git add services/property_images/redfin_scraper.py tests/services/property_images/test_redfin_scraper.py
...
Run: `cd /home/astre/command-center/src/greenlit/collections && pytest tests/services/property_images/test_redfin_scraper.py -v --timeout=180`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && pytest tests/services/property_images/test_redfin_scraper.py::TestRedfinScraper::test_stealth_is_applied -v`
...
```bash
cd /home/astre/command-center/src/greenlit/collections && git add tests/services/property_images/test_redfin_scraper.py
...
Run: `cd /home/astre/command-center/src/greenlit/collections && pytest tests/services/property_images/ -v --timeout=180`

Expected: All tests pass

**Step 2: Run a manual integration test**

Run: `cd /home/astre/command-center/src/greenlit/collections && python3 -m services.property_images.image_fetcher "3705 Desert Ridge Dr, Fort Worth TX 76116" "Fort Worth" "test_manual"`

Expected: Either fetches image or fails gracefully with informative logging

**Step 3: Update docs/archive/SESSION-NOTES.md with fixes applied**

Add to docs/archive/SESSION-NOTES.md under "### Notes":
...
```bash
cd /home/astre/command-center/src/greenlit/collections && git add -A
...
| `docs/archive/SESSION-NOTES.md` | Document fixes applied |
