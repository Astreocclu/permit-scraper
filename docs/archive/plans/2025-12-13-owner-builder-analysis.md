...
Run: `cd /home/astre/command-center/src/greenlit/collections && pytest tests/test_owner_builder.py::TestNormalizeName -v`
...
```bash
cd /home/astre/command-center/src/greenlit/collections && git add tests/test_owner_builder.py scripts/analyze_owner_builder.py && git commit -m "feat: add owner-builder analysis with name normalization"
```
...
Run: `cd /home/astre/command-center/src/greenlit/collections && pytest tests/test_owner_builder.py::TestIsContractorEntity -v`
...
```bash
cd /home/astre/command-center/src/greenlit/collections && git add scripts/analyze_owner_builder.py tests/test_owner_builder.py && git commit -m "feat: add contractor entity detection"
```
...
Run: `cd /home/astre/command-center/src/greenlit/collections && pytest tests/test_owner_builder.py::TestNamesMatch -v`
...
```bash
cd /home/astre/command-center/src/greenlit/collections && git add scripts/analyze_owner_builder.py tests/test_owner_builder.py && git commit -m "feat: add name matching logic for owner-builder detection"
```
...
Run: `cd /home/astre/command-center/src/greenlit/collections && pytest tests/test_owner_builder.py::TestCategorizeApplicant -v`
...
```bash
cd /home/astre/command-center/src/greenlit/collections && git add scripts/analyze_owner_builder.py tests/test_owner_builder.py && git commit -m "feat: add categorize_applicant function"
```
...
def main():
    ...
    parser.add_argument('--output', '-o', default='docs/archive/LEAD_QUALITY_REPORT.md',
                        help='Output file path (default: docs/archive/LEAD_QUALITY_REPORT.md)')
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scripts/analyze_owner_builder.py --limit 1000`
...
Report saved to: docs/archive/LEAD_QUALITY_REPORT.md
```

**Step 3: Verify report was generated**

Run: `cd /home/astre/command-center/src/greenlit/collections && head -50 docs/archive/LEAD_QUALITY_REPORT.md`

Expected: Markdown report with Data Coverage table and Executive Summary

**Step 4: Run all tests to ensure nothing broke**

Run: `cd /home/astre/command-center/src/greenlit/collections && pytest tests/test_owner_builder.py -v`
Expected: All tests PASS

**Step 5: Commit**

```bash
cd /home/astre/command-center/src/greenlit/collections && git add scripts/analyze_owner_builder.py && git commit -m "feat: complete owner-builder analysis script with report generation"
```
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scripts/analyze_owner_builder.py`

Expected: Script runs successfully, generates docs/archive/LEAD_QUALITY_REPORT.md

**Step 2: Review generated report**

Run: `cd /home/astre/command-center/src/greenlit/collections && cat docs/archive/LEAD_QUALITY_REPORT.md`
...
```bash
cd /home/astre/command-center/src/greenlit/collections && git add docs/archive/LEAD_QUALITY_REPORT.md && git commit -m "docs: add baseline lead quality analysis report"
```
...
- `docs/archive/LEAD_QUALITY_REPORT.md` - Generated report (output)
