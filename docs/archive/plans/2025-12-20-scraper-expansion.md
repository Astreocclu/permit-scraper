...
Run: `cd /home/reid/command-center/src/greenlit/collections && python3 scripts/explore_lewisville.py`
...
Run: `cd /home/reid/command-center/src/greenlit/collections && python3 scrapers/tyler_esuite.py lewisville 100`
...
## Task 4: Add Lewisville to docs/archive/SCRAPER_STATUS.md
...
Run: `cd /home/reid/command-center/src/greenlit/collections && python3 scrapers/mgo_connect.py Irving 100 2>&1 | tee /tmp/irving_test.log`
...
Run: `cd /home/reid/command-center/src/greenlit/collections && python3 scripts/test_richardson_proxy.py`
...
```bash
cd /home/reid/command-center/src/greenlit/collections
