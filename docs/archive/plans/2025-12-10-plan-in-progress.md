...
1. Open Grapevine permit URL in browser - check if:
   ...
   - Requires .exe download (noted in docs/archive/SCRAPER_STATUS.md)
...
- Mark city as "Manual Only" in docs/archive/SCRAPER_STATUS.md
...
**Carrollton:**
- Verify CityView claim from docs/archive/SCRAPER_STATUS.md
...
- `docs/archive/SCRAPER_STATUS.md` (update with findings)
