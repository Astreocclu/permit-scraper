...
Run: `cd /home/astre/command-center/src/greenlit/collections && pytest tests/services/browser_scraper/test_status_tracker.py -v`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && pytest tests/services/browser_scraper/test_failure_classifier.py -v`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python -m services.browser_scraper.shepherd --status`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && pytest tests/services/browser_scraper/test_shepherd_integration.py -v`
