...
Clean up the Collections codebase by:
...
```bash
mv /home/astre/command-center/src/greenlit/collections/*_raw.json /home/astre/command-center/src/greenlit/collections/data/raw/ 2>/dev/null || true
```
