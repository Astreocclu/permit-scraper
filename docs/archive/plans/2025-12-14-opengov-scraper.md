...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/opengov.py --list`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/opengov.py highland_park 10`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && pytest tests/test_opengov.py -v`
