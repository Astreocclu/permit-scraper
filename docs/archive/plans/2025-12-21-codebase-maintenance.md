...
**Codebase:** Collections (DFW Signal Engine)
...
Untracked:
  ...
  - docs/archive/plans/2025-12-21-browseruse-burleson-southlake.md
...
- [ ] Stage `docs/archive/plans/2025-12-21-browseruse-burleson-southlake.md`
...
### 4.3 Old Plan Files
**Found:** 20 plan files in `docs/archive/plans/`

Oldest: `IMPLEMENTATION_PLAN_2025-12-09.md`

**Action:**
- [ ] Review if any can be archived (move to `docs/archive/plans/archive/`)
...
git add docs/archive/plans/2025-12-21-browseruse-burleson-southlake.md
