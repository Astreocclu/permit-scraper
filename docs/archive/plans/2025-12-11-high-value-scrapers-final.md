...
Run: `cd /home/astre/command-center/src/greenlit/collections && pip install -r requirements.txt`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 -c "from scrapers.mygov_westlake import *; print('OK')"`
Expected: OK
...
Run: `cd /home/astre/command-center/src/greenlit/collections && timeout 60 python3 scrapers/mygov_westlake.py --test 2>&1 | head -30`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 -c "from scrapers.utils import parse_excel_permits; print('OK')"`
Expected: OK
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 -c "from scrapers.citizen_self_service import *; print('OK')"`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 -m py_compile scrapers/irving_pdf_sampler.py && echo "Syntax OK"`
Expected: Syntax OK
...
**Files:**
- Modify: `docs/archive/SCRAPER_STATUS.md` (or create if doesn't exist)
...
| Documentation | `docs/archive/SCRAPER_STATUS.md` | Ready |
