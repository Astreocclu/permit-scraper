...
Run: `cd /home/astre/command-center/src/greenlit/collections && pytest tests/test_etrakit_config.py -v`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/etrakit.py the_colony 20`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 -c "from services.browser_scraper.runner import PermitScraperRunner; print('Runner imports OK')"`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scripts/load_permits.py --city southlake`
...
**Step 4: Update docs/archive/LEADS_INVENTORY.md**
...
```bash
git add docs/archive/LEADS_INVENTORY.md
