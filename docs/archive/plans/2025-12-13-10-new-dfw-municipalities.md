...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/etrakit.py the_colony 10`
...
```bash
cd /home/astre/command-center/src/greenlit/collections && git add scrapers/etrakit.py && git commit -m "feat: add The Colony to eTRAKiT scraper"
```
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/mygov_multi.py university_park 10`

Expected: Should find addresses and extract permits (may get 0-10 depending on recent activity).

**Step 3: Test Forney scraper**

Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/mygov_multi.py forney 10`
...
```bash
cd /home/astre/command-center/src/greenlit/collections && git add scrapers/mygov_multi.py && git commit -m "feat: add University Park and Forney to MyGov scraper"
```
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/citizen_self_service.py hurst 10`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/citizen_self_service.py farmers_branch 10`

Expected: Should work similarly to Southlake.

**Step 4: Test North Richland Hills scraper**

Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/citizen_self_service.py north_richland_hills 10`

Expected: Should work with standard EnerGov CSS interface.

**Step 5: Test Coppell scraper (HIGH RISK)**

Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/citizen_self_service.py coppell 10`
...
```bash
cd /home/astre/command-center/src/greenlit/collections && git add scrapers/citizen_self_service.py && git commit -m "feat: add Hurst, Farmers Branch, NRH, Coppell to EnerGov CSS scraper"
```
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/accela_fast.py duncanville 10`
...
```bash
cd /home/astre/command-center/src/greenlit/collections && git add scrapers/accela_fast.py && git commit -m "feat: add Duncanville to Accela scraper"
```
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/citizen_self_service.py mckinney 10`

Expected: Should complete without timeout errors. May take 30-60 seconds.

**Step 5: Test Allen with extended waits**

Run: `cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/citizen_self_service.py allen 10`
...
```bash
cd /home/astre/command-center/src/greenlit/collections && git add scrapers/citizen_self_service.py && git commit -m "fix: add Angular wait logic for McKinney and Allen scrapers"
```
...
```bash
cd /home/astre/command-center/src/greenlit/collections && git add TODO.md && git commit -m "docs: update TODO with new city coverage"
```
...
Run: `cd /home/astre/command-center/src/greenlit/collections && pytest -v`
