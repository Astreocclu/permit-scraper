...
Run: `cd /home/astre/command-center/src/greenlit/collections && python -m pytest tests/test_adjacent_trades.py -v`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python scripts/adjacent_trades.py --limit 100`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python scripts/adjacent_trades.py --limit 500`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python -m pytest tests/ -v`
Expected: All tests PASS
