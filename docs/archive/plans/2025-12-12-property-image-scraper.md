...
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 -c "from services.property_images.models import PropertyImage; print('OK')"
```
...
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 -m pytest tests/services/property_images/test_cad_lookup.py -v
```
...
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 -m pytest tests/services/property_images/test_tad_scraper.py -v
```
...
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 -m pytest tests/services/property_images/test_tad_scraper.py -v --timeout=60
```
...
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 -m pytest tests/services/property_images/test_redfin_scraper.py -v
```
...
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 -m pytest tests/services/property_images/test_redfin_scraper.py -v --timeout=120
```
...
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 -m pytest tests/services/property_images/test_image_fetcher.py -v
```
...
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 -m pytest tests/services/property_images/test_image_fetcher.py -v --timeout=120
```
...
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 -m pytest tests/services/property_images/test_integration.py -v --timeout=180 -m integration
```
...
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 -m services.property_images.image_fetcher "3705 DESERT RIDGE DR, Fort Worth TX 76116" "Fort Worth" "cli_test_001"
```
