...
**Step 2: Test**
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/mygov_multi.py highland_park 10
```
...
**Step 3: Test**
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/citizen_self_service.py princeton 10
```
...
**Step 2: Test**
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/mygov_multi.py royse_city 10
```
...
**Step 2: Test**
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/mygov_multi.py heath 10
```
