...
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/citizen_self_service.py colleyville 10
```
...
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/citizen_self_service.py southlake 20
```
...
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/citizen_self_service.py southlake 50
cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/citizen_self_service.py colleyville 50
```
...
```bash
cd /home/astre/command-center/src/greenlit/collections && git add scrapers/citizen_self_service.py && git commit -m "feat: add Colleyville, fix EnerGov wait/regex"
```
...
Then run:
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/mgo_connect.py Irving 10
```
...
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/mgo_connect.py Irving 100
```
...
```bash
cd /home/astre/command-center/src/greenlit/collections && git add scrapers/mgo_connect.py && git commit -m "fix: Irving dropdown race condition - wait for jurisdiction list"
```
...
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/mygov_westlake.py
```
...
If blocked: Document in docs/archive/SCRAPER_STATUS.md and skip

---

## Task 7: Update docs/archive/SCRAPER_STATUS.md
...
```bash
cd /home/astre/command-center/src/greenlit/collections && git add docs/archive/SCRAPER_STATUS.md && git commit -m "docs: update scraper status for high-value cities"
```
