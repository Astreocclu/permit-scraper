...
Run: `cd /home/astre/command-center/src/greenlit/collections && python -m pytest tests/test_score_leads.py -v`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python -m pytest tests/test_score_leads.py::TestIsCommercialEntity -v`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python -m pytest tests/test_score_leads.py::TestShouldDiscardCommercial -v`
...
Run: `cd /home/astre/command-center/src/greenlit/collections && python -m pytest tests/test_score_leads.py::TestTierAssignment -v`
...
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 scripts/score_leads.py --dry-run --limit 500 2>&1 | head -50
```
...
find /home/astre/command-center/src/greenlit/collections/exports -name "*tier_d*" -type f
# Should return nothing

# Verify tier_a/b/c/u exist
ls -la /home/astre/command-center/src/greenlit/collections/exports/*/tier_*.csv 2>/dev/null | head -10
```
