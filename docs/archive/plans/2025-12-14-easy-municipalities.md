...
Run:
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/etrakit.py burleson 50
```
...
Run:
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/citizen_self_service.py desoto 100
```
...
**Step 4: If successful, update docs/archive/SCRAPER_STATUS.md**

Add DeSoto to the working cities list in docs/archive/SCRAPER_STATUS.md.
...
Run:
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/mygov_multi.py little_elm 100
```
...
Run:
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/mygov_multi.py rowlett 100
```
...
Run:
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/mygov_multi.py mansfield 100
```
...
**Step 1: Update docs/archive/SCRAPER_STATUS.md**
...
```bash
git add docs/archive/SCRAPER_STATUS.md TODO.md
