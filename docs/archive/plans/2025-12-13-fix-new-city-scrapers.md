...
**Files:**
- Modify: `/home/astre/command-center/src/greenlit/collections/scrapers/citizen_self_service.py:85-89`
...
Edit `/home/astre/command-center/src/greenlit/collections/scrapers/citizen_self_service.py` line 85-89:
...
Edit `/home/astre/command-center/src/greenlit/collections/scrapers/citizen_self_service.py` around line 238, after `permit_type` parameter check:
...
Run:
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/citizen_self_service.py mesquite 100
```
...
Run:
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 -c "
import json
...
**Files:**
- Modify: `/home/astre/command-center/src/greenlit/collections/scrapers/etrakit.py:90-157`
- Test: Manual scraper run
...
Edit `/home/astre/command-center/src/greenlit/collections/scrapers/etrakit.py` line 131-142, improve field extraction:
...
Run:
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/etrakit.py prosper 100 2>&1 | head -50
```
...
**Files:**
- Modify: `/home/astre/command-center/src/greenlit/collections/scrapers/etrakit.py:71-78`
- Modify: `/home/astre/command-center/src/greenlit/collections/docs/research/dfw_municipalities.json`
...
Edit `/home/astre/command-center/src/greenlit/collections/scrapers/etrakit.py` line 71-78, remove or comment out Keller:
...
Edit `/home/astre/command-center/src/greenlit/collections/docs/research/dfw_municipalities.json`, update Keller entry:
...
**Files:**
- Modify: `/home/astre/command-center/src/greenlit/collections/scrapers/mygov_multi.py:67-146`
...
If Grapevine uses a different input selector or search mechanism, update `/home/astre/command-center/src/greenlit/collections/scrapers/mygov_multi.py` line 76-84:
...
Run:
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/mygov_multi.py grapevine 100 2>&1 | head -50
```
...
Edit `/home/astre/command-center/src/greenlit/collections/scrapers/mygov_multi.py` line 35:
...
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/citizen_self_service.py mesquite 500
```
...
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/etrakit.py prosper 500
```
...
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/etrakit.py keller 10 2>&1 | head -5
```
...
```bash
cd /home/astre/command-center/src/greenlit/collections && python3 scrapers/mygov_multi.py grapevine 100 2>&1 | tail -20
```
